        ...
        <div className="container page-padding ">
          ...
          <div className="text-white w-[52rem] min620:w-[100%] relative">
            <h2 className="text-[4rem] font-bold leading-[1.1] mb-8">
              Let's Calculate Your <span className="text-[#7b0f20]">BMI</span>
            </h2>
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-10 gap-3 text-[16px] font-medium flex items-center w-full ">
                <span className="w-1/2">
                  Your BMI is: &nbsp;
                  <span className="text-[#7b0f20]">{bmi}</span>
                </span>
                <span className="w-1/2">
                  Your weight is: &nbsp;
                  <span className="text-[#7b0f20]">{message}</span>
                </span>
              </p>
              <button
                onClick={calcBmi}
                ...
                type="submit"
                className="text-[15px] uppercase font-bold mt-10 bg-[#323232] w-[15rem] h-[5rem] hover:bg-[#7b0f20]"
              >
                Calculate
              </button>
            </div>
