...
import Logo from "../../images/logo/logoo-light.png";
import NavList from "../Nav/NavList";
import { Link } from "react-router-dom";
import LogoSide from "../../images/logo/logoo.png";
      ...
      >
        ...
        <div className="flex items-center gap-10">
          <div className="flex gap-10">
            ...
            >
              <i
                ...
                className="fa-solid fa-xmark text-[#7b0f20] text-[3.3rem] cursor-pointer self-end"
              ></i>
              ...
              <ul className="text-center flex flex-col gap-10 absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]">
                <li onClick={hamburgerMenu}>
                  <a
                    ...
                    className="text-[2rem] font-medium hover:text-[#7b0f20] ease-in duration-200"
                    href="/#home"
                  >
                    Home
                  </a>
            ...
            <div>
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <img src={LogoSide} alt="logo_img" className="w-[25rem]" />
                  <i
                    onClick={sideBar}
                    className="fa-solid fa-xmark text-[#7b0f20] text-[3.3rem] cursor-pointer"
                  ></i>
                </div>
                {/* about us */}
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#7b0f20] cursor-pointer ease-in duration-200">
                    <i className="fa-solid fa-location-dot text-[#7b0f20]"></i>
                    &nbsp; Kec. Banyuwangi, Kabupaten Banyuwangi, Jawa Timur
                  </p>
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#7b0f20] cursor-pointer ease-in duration-200">
                    <i className="fa-solid fa-phone text-[#7b0f20]"></i>&nbsp;
                    +800-123-4567
                  </p>
                  <p className="text-[1.6rem] font-medium text-[#000000b1] hover:text-[#7b0f20] cursor-pointer ease-in duration-200">
                    <i className="fa-solid fa-envelope text-[#7b0f20]"></i>
                    &nbsp; ignitegym@gmail.com
                  </p>
                </div>
                {/* follow us */}
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex gap-5">
                    <span className="bg-[#7b0f20] rounded-full py-[12px] px-[17px] cursor-pointer">
                      <i className="fa-brands fa-facebook-f text-[2.2rem] text-white"></i>
                    </span>
                    <span className="bg-[#7b0f20] rounded-full py-[12px] px-[12px] cursor-pointer">
                      <i className="fa-brands fa-twitter text-[2.2rem] text-white"></i>
                    </span>
                    <span className="bg-[#7b0f20] rounded-full py-[10px] px-[13px] cursor-pointer">
            ...
            <i
              onClick={hamburgerMenu}
              className="fa-bars fa-solid hidden text-white text-4xl cursor-pointer hover:text-[#7b0f20] ease-in duration-200"
            ></i>
            {/* account */}
            <Link onClick={goTop} to="/signup" title="signup_button">
              <i className="fa-regular fa-user  text-white text-4xl cursor-pointer hover:text-[#7b0f20] ease-in duration-200"></i>
            </Link>
            {/* sidebar */}
            <i
              onClick={sideBar}
              className="fa-regular fa-chart-bar text-white text-4xl cursor-pointer hover:text-[#7b0f20] ease-in duration-200"
            ></i>
          </div>
          {/* spin box */}
          <div className="border-[rgb(255,255,255,0.3)] border-solid border-2  p-2 rounded-md min620:hidden">
            ...
            >
              <i
                className={`fa-solid fa-plus bg-[#7b0f20] text-white text-2xl py-3 px-4 rounded-md ${
                  spin ? "nav-btn-hover" : ""
                }`}
              ></i>
