...
function Featured() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-4 grid-rows-2 gap-7 h-full mt-7 md1000:flex md1000:flex-col">
            <div className="item-0-div relative">
              ...
              <div className="absolute z-10 bottom-10 left-10">
                ...
                <p className="text-white bg-[#7b0f20] text-[16px] mt-3 py-1 px-5">
      ...
      {/* featured cta */}
      <div className="featured-cta flex justify-center text-left items-center md1000:bg-none md1000:bg-[#7b0f20] ">
